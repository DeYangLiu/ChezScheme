...
#ifdef ANDROID
//#define LOCK_SH 1  LOCK_EX 2 LOCK_NB 4 LOCK_UN 8
#define FLOCK flock
#define NOFILE 256
...
#define NSECATIME(sb) (sb).st_atime_nsec
#define NSECCTIME(sb) (sb).st_ctime_nsec
#define NSECMTIME(sb) (sb).st_mtime_nsec
